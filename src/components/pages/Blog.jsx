      ...
      <div className="row">
        ...
        <div className="container col-md-5 card ml-2 mr-2">
          ...
          <a href="https://github.com/f-kreuk/5-day-weather/tree/main">
            <img src="src\assets\5-day-weather.PNG" alt="5-day-weather" className="project-image mb-4" />
          </a>
        </div>
        ...
        <div className="container col-md-5 card ml-2 mr-2">
          ...
          <a href="https://github.com/f-kreuk/Note-Taker">
            <img src="src\assets\NoteTaker.JPG" alt="Note-Taker" className="project-image mb-4" />
          </a>
        </div>
        ...
        <div className="container col-md-5 card ml-2 mr-2">
          ...
          <a href="https://github.com/f-kreuk/code-quiz">
            <img src="src\assets\code-quiz.JPG" alt="code-quiz" className="project-image mb-4" />
          </a>
        </div>
        ...
        <div className="container col-md-5 card ml-2 mr-2">
          ...
          <a href="https://github.com/f-kreuk/E-commerce-Back-End/tree/main">
            <img src="src\assets\ecBackend.JPG" alt="E-commerce-Back-End" className="project-image mb-4" />
          </a>
        </div>
        ...
        <div className="container col-md-5 card ml-2 mr-2">
          ...
          <a href="https://github.com/f-kreuk/Social-Network-API/tree/main">
            <img src="src\assets\snAPI.JPG" alt="Social-Network-API" className="project-image mb-4" />
          </a>
        </div>
